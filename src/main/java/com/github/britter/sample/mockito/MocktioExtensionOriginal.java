 ...
 * </code></pre>
 */
public class MocktioExtensionOriginal implements TestInstancePostProcessor,BeforeEachCallback, AfterEachCallback, ParameterResolver {
    ...
    public MocktioExtensionOriginal() {
        this(Strictness.STRICT_STUBS);
    }

    private MocktioExtensionOriginal(Strictness strictness) {
